puts "🌱 Creating Gods..."
athena = OlympianGod.create(name: "Athena", title: "Goddess of Wisdom", image: "https://static.wikia.nocookie.net/hades_gamepedia_en/images/3/3c/Athena_reward.png")
zeus = OlympianGod.create(name: "Zeus", title: "King of the Olympians", image: "https://static.wikia.nocookie.net/hades_gamepedia_en/images/b/b2/Zeus_reward.png")
aphrodite = OlympianGod.create(name: "Aphrodite", title: "Goddess of Love And Beauty", image: "https://static.wikia.nocookie.net/hades_gamepedia_en/images/5/5a/Aphrodite_reward.png")
ares = OlympianGod.create(name: "Ares", title: "God of War", image: "https://static.wikia.nocookie.net/hades_gamepedia_en/images/0/06/Ares_reward.png")
artemis = OlympianGod.create(name: "Artemis", title: "Goddess of the Hunt", image: "https://static.wikia.nocookie.net/hades_gamepedia_en/images/2/2c/Artemis_Reward.png")
poseidon = OlympianGod.create(name: "Poseidon", title: "God of the Sea", image: "https://static.wikia.nocookie.net/hades_gamepedia_en/images/9/9d/Poseidon_reward.png")
demeter = OlympianGod.create(name: "Demeter", title: "Goddess of the Seasons", image: "https://static.wikia.nocookie.net/hades_gamepedia_en/images/4/46/Demeter_reward.png")
dionysus = OlympianGod.create(name: "Dionysus", title: "God of Wine", image: "https://static.wikia.nocookie.net/hades_gamepedia_en/images/4/41/Dionysus_reward.png")
hermes = OlympianGod.create(name: "Hermes", title: "God of Swiftness", image: "https://static.wikia.nocookie.net/hades_gamepedia_en/images/c/ce/Hermes_reward.png")
